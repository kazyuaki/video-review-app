...
export default function WorkCard({
  ...
  return (
    <Link
      href={`/works/${work.mediaType}/${work.id}`}
      className={`group block overflow-hidden rounded-2xl border border-white/10 bg-white/5 transition hover:-translate-y-1 hover:bg-white/10 ${
